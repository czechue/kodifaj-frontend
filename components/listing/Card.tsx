...
const Card: React.FC<CardProps> = ({ task }) => {
  return (
    <div className="flex flex-col items-center">
      <section className="mt-4 w-full xs:max-w-400 transform translate-y-0 bg-gray-100 shadow-sm rounded-md transition-shadow transition-transform duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg overflow-hidden">
