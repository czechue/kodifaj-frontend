    ...
    <section className="w-full md:w-1/3">
      ...
      <div className="flex items-center justify-between px-2 mt-4">
        ...
        <p className="text-sm w-7/12">
          Dodane nowe zadanie: <span className="text-red-500">Karuzela w czystym JS</span>
        </p>
      ...
      <div className="flex items-center justify-between px-2 mt-4">
        ...
        <p className="text-sm w-7/12">
          Dodane nowe rozwiązanie: <span className="text-red-500">Karuzela w czystym JS</span>
        </p>
      ...
      <div className="flex items-center justify-between px-2 mt-4">
        ...
        <div className="text-sm w-7/12">
          Oceniono zadanie: <span className="text-red-500">Karuzela w czystym JS</span>
          <Stars rating={4.7} />
        </div>
