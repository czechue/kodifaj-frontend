  ...
  return (
    <div className="flex flex-col items-center mt-4">
      <Link href="/tasks/[taskId]" as={`/tasks/${_id}`}>
        <a className="w-full bg-white transform translate-y-0 shadow-sm rounded-md transition-shadow transition-transform duration-200 ease-in-out hover:-translate-y-1 hover:shadow-lg overflow-hidden cursor-pointer border rounded-md">
          <section>
